...
def generate_c64_audio(notes, sample_rate=44100, 
                      ...
                      sync_channels=[],       # 默认禁用同步
                      ring_mod=False,         # 默认禁用环形调制
...
#     elif mode == 'c64':
#         return generate_c64_audio(notes, wave_types=['sawtooth', 'pulse', 'noise'], filter_type='lowpass', filter_cutoff=3000, ring_mod=True,adsr_params=(0.01, 0.2, 0.7, 0.1))
#     else:
#         continue
...
if __name__ == '__main__':
    ...
    audio = generate_c64_audio(notes, wave_types=['sawtooth', 'pulse', 'noise'], filter_type='lowpass', filter_cutoff=3000, ring_mod=True,adsr_params=(0.01, 0.2, 0.7, 0.1))
